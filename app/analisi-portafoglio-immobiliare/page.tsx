...
const config: PageConfig = {
    ...
    faqs: [
        ...
        { q: "Come influisce l'inflazione sul mio portafoglio a Reggio Emilia?", a: "L'immobile è un bene rifugio, ma i canoni devono essere aggiornati all'indice ISTAT per non perdere potere d'acquisto. Analizziamo se i tuoi contratti attuali prevedono le clausole di salvaguardia corrette." },
        { q: "Mi aiutate a rinegoziare i canoni di affitto esistenti?", a: "Sì. Spesso gli investitori temono di perdere l'inquilino, ma un canone sotto mercato è una perdita secca di ROI. Valutiamo la solvibilità e proponiamo adeguamenti in linea con i valori attuali." },
        { q: "Conviene ristrutturare prima di vendere o vendere nello stato attuale?", a: "Dipende dal tipo di acquirente target. Per gli investitori, spesso conviene vendere 'da ristrutturare' con un progetto approvato. Per le famiglie, una ristrutturazione 'chiavi in mano' può aumentare il margine del 20%." },
        { q: "Come posso diversificare il portafoglio restando in provincia?", a: "Reggio Emilia offre micro-mercati diversi: il centro per il breve termine/studenti, la prima periferia per le famiglie, i distretti industriali per i lavoratori fuori sede. Ti aiutiamo a bilanciare il rischio." },
        { q: "Valutate anche immobili commerciali o uffici?", a: "Sì, sebbene il nostro focus sia il residenziale, analizziamo immobili commerciali per valutare eventuali cambi di destinazione d'uso in abitativo, che spesso è l'operazione a maggior valore aggiunto." },
        { q: "Qual è le rendimento netto medio atteso a Reggio oggi?", a: "Attualmente il rendimento netto (al netto di tasse e spese) oscilla tra il 4% e il 6% per il residenziale standard. Operazioni più mirate possono toccare l'8-9%." },
        { q: "Come gestite il rischio di morosità degli inquilini?", a: "In fase di analisi portafoglio, verifichiamo la 'salute' dei contratti in essere e ti suggeriamo polizze di tutela legale o fideiussioni che possono rendere i tuoi asset molto più appetibili in caso di vendita." },
    ],
