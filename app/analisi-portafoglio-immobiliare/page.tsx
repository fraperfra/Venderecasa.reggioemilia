...
const config: PageConfig = {
    ...
    socialProofTitle: "Portafogli ottimizzati a Reggio Emilia",
    socialProofSubtitle: "Alcuni degli immobili analizzati e valorizzati per i nostri investitori. Foto dei casi reali in arrivo.",
