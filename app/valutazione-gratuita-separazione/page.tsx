...
const config: PageConfig = {
    ...
    socialProofTitle: "Vendite gestite con professionalità e discrezione",
    socialProofSubtitle: "Alcuni degli immobili venduti durante situazioni di separazione a Reggio Emilia. Foto dei casi reali in arrivo.",
