...
const config: PageConfig = {
    ...
    faqs: [
        ...
        { q: "Posso vendere se ho già ricevuto un atto di precetto?", a: "Sì, ma i tempi diventano strettissimi. È fondamentale agire prima che venga fissata la prima asta. Possiamo ancora negoziare un 'saldo e stralcio' con la banca per chiudere il debito ed evitare che la casa venga svenduta forzatamente." },
        { q: "La banca può rifiutarsi di liberare l'ipoteca se il prezzo di vendita è basso?", a: "La banca libera l'ipoteca solo se riceve l'intera somma del debito residuo o se accetta un accordo transattivo (saldo e stralcio). Noi negoziamo per te affinché il prezzo ottenuto sia accettato come estintivo." },
        { q: "Cosa succede al garante del mio mutuo se vendo in perdita?", a: "Se la vendita non copre tutto il debito, il garante rimane responsabile per la differenza. Per questo puntiamo a transazioni che includano la liberazione tombale del debito per tutte le parti coinvolte." },
        { q: "Come si gestisce la polizza vita legata al mutuo in caso di vendita?", a: "In caso di estinzione anticipata del mutuo per vendita, hai diritto al rimborso della quota di premio non goduta della polizza assicurativa. Ti aiutiamo a presentare la richiesta alla compagnia." },
        { q: "Posso sospendere le rate mentre cerco di vendere?", a: "Esistono moratorie specifiche (come il Fondo Gasparrini), ma hanno requisiti rigidi. Spesso è più efficace comunicare alla banca che l'immobile è in vendita con un professionista per ottenere una tolleranza temporanea." },
        { q: "Qual è la differenza tra estinzione totale e cancellazione dell'ipoteca?", a: "L'estinzione chiude il debito economico; la cancellazione (Legge Bersani) rimuove il vincolo legale sulla casa. Il notaio si assicura che entrambe avvengano contestualmente alla vendita." },
        { q: "Se vendo a 'saldo e stralcio', sarò segnalato in CRIF?", a: "La sofferenza è probabilmente già segnalata se sei in ritardo. Il saldo e stralcio però chiude la posizione 'a sofferenza', permettendoti di riabilitare il tuo profilo creditizio molto più velocemente rispetto a un'esecuzione immobiliare." },
    ],
